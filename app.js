var app = angular.module("checkrideApp", ['ngRoute','ui.calendar', 'firebase', 'examinerDirectives','examinerCalendar']);
...
app.config(function($routeProvider){
    $routeProvider.when("/",{
        templateUrl:"user/loginPage.html",
        controller:'login'
    })
    .when("/createAccount", {
        templateUrl: 'user/createAccountPage.html',
        controller:'createAccount'
    })
    .when("/examiner",{
        templateUrl:"examinerFiles/examinerCalendar.html",
        controller:"examinerCalendar"
    })
    .when("/student",{
        templateUrl:'StudentFiles/examinerList.html',
        controller:"examinerList"
    })
});


app.controller("login", ["loginService","$scope","$firebaseObject", "commonServices",function(loginService, $scope, $firebaseObject,commonServices){
    var usersRef  = new Firebase("https://checkride.firebaseio.com/users/");
    commonServices.changeLocationOnClick("#createAcctBtn", "/createAccount");
    
    $("#signIn").on("click", function(){
        loginService.signIn($("#email").val(), $("#password").val()); 
    });
