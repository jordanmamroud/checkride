...
myApp.directive("examinerNavbar", function(){
   return{
       template:'<nav class="navbar navbar-inverse"><div class="container-fluid"><div class="navbar-header"><button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a class="navbar-brand" href="#" id="userName">Brand</a></div><div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1"><ul class="nav navbar-nav"><li class="active"><a href="http://127.0.0.1:57138/examinerFiles/examinerHomePage.html">Home <span class="sr-only">(current)</span></a></li><li><a href="http://127.0.0.1:57138/examinerFiles/examinerCalendar.html">Calendar</a></li></ul></div></div></nav>'
   } 
});
