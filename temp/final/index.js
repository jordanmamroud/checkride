...
console.log('hlkdajf;alsd;ljfaksdf');
...
//var numbersRef = db.ref("numbers");

//
//numbersRef.on("child_added", function(){
//    console.log("asd");
//});
//var numbersList = [];
//numbersRef.on("child_added", function(datasnapshot){
//    numbersList.push(datasnapshot.val().number);
//});

//usersRef.on("value", function(datasnapshot){
//    datasnapshot.forEach(function(childsnapshot){
//        if(numbersList.indexOf(childsnapshot.val().userData.phone) == -1){
//           console.log("hello");
//       } else{
//           
//       }
